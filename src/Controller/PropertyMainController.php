...
class PropertyMainController extends AbstractController {
    ...
    public function __construct(PropertyMainRepository $repository)
    {
    ...
    */
     ...
     * @return Response
    */
    public function show(PropertyMain $property, string $slug): Response {
